...
// The new feature: Live overview popup for MathJax in TinyMCE
...
// To sees if there is $$...$$ or $...$ in text, we need to get the full text of the editor
...
// When you click in the editor, this function checks if you are inside a LaTeX formula
...
export function getTinymceBaseConfig(page: string): object {
  ...
  return {
    ...
    setup: (editor: Editor): void => {
      ...
      // styling. Could be done in CSS, but this is easier for now.
      ...
      // If key stroke is too fast, popup function will be broken. So we need to debounce it
